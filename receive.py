...
import osmosdr
import time
import receive_ook2bin as ook2bin  # embedded python block
...
class receive(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.bandwith = bandwith = samp_rate / 8
        ...
        self._freq_range = Range(0, 3e9, 1e3, 433e6, 200)
        self._freq_win = GrRangeWidget(self._freq_range, self.set_freq, "Center frequency (Hz)", "counter_slider", float, QtCore.Qt.Horizontal, "value")

        self.top_layout.addWidget(self._freq_win)
        self._bandwith_range = Range(samp_rate / 100, samp_rate / 2, 1, samp_rate / 8, 200)
        self._bandwith_win = GrRangeWidget(self._bandwith_range, self.set_bandwith, "Reception bandwith (Hz)", "counter_slider", float, QtCore.Qt.Horizontal, "value")
        ...
        self.qtgui_time_sink_x_1.set_y_label('Amplitude', "bin")
        ...
        self.osmosdr_source_0.set_center_freq((freq + dc_offset_correction), 0)
        ...
        self.ook2bin = ook2bin.blk(baseband_freq=600, sample_rate=2000000.0, sink_file=None)
        ...
        self.connect((self.blocks_threshold_ff_0, 0), (self.ook2bin, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_bandwith(self.samp_rate / 8)
        self.set_dc_offset_correction(self.samp_rate / 4)
        self.band_pass_filter_0.set_taps(firdes.complex_band_pass(1, self.samp_rate, ((self.dc_offset_correction -self.bandwith)), ((self.dc_offset_correction + self.bandwith)), 5e3, window.WIN_HAMMING, 6.76))
    ...
    def set_freq(self, freq):
        self.freq = freq
        self.osmosdr_source_0.set_center_freq((self.freq + self.dc_offset_correction), 0)
        self.qtgui_sink_x_0.set_frequency_range(self.freq, self.samp_rate)
